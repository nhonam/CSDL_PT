...
namespace QLDSVHTC
{
    public partial class FrptBDMH : Form
    {
        public FrptBDMH()
        {
            InitializeComponent();
        ...
        private void FrptBDMH_Load(object sender, EventArgs e)
        {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            Xprt_BD_MH_Report rpt = new Xprt_BD_MH_Report(nienkhoa, hocky, nhom, monhoc);
        ...
        private void cbHocKi_SelectedIndexChanged_1(object sender, EventArgs e)
        {
