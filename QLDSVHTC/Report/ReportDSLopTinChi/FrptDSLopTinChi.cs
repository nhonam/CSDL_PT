...
namespace QLDSVHTC
{
    public partial class FrptDSLopTinChi : Form
    {
        public FrptDSLopTinChi()
        {
            InitializeComponent();
        }

        private void FrptDSLopTinChi_Load(object sender, EventArgs e)
        {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            RpDSLopTinChi rpt = new RpDSLopTinChi(nienkhoa, hocky);
